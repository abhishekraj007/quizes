...
var $indicators = $('<ol>')
  ...
  */
  ...
  var $social = $("<div>")
    ...
    .html('<div id = "social-text">Did you like this app? Was this app helpful in your exam preparatin? Share this app with your friends, so they can give it a shot!</div>')
    .appendTo($results_slide);
  ...
  $("<button>")
    .attr('class', 'btn btn-otline-primary')
    .text("Try again?")
    .click(function() {
      state.correct = 0;
      $quiz.carousel(0);
